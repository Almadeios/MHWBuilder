...
export const getSearchParameters = parameters => {
    ...
    return {
        ...
        recommendationSlots: parameters.recommendationSlots || {},
        ...
        disableSkillPruning: parameters.disableSkillPruning !== false,
        disableMatchingCache: Boolean(parameters.disableMatchingCache),
